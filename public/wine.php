<?php
  class Wine{
    ...
    function __construct($style, $name, $grape, $producer, $year, $region, $stock){

      $style_error = $this->set_wine_style($style) == TRUE? 'TRUE,' : 'FALSE,';
      $name_error = $this->set_wine_name($name) == TRUE? 'TRUE,' : 'FALSE,';
      $grape_error = $this->set_wine_grape($grape) == TRUE? 'TRUE,' : 'FALSE,';
      $producer_error = $this->set_wine_producer($producer) == TRUE? 'TRUE,' : 'FALSE,';
      $year_error = $this->set_wine_year($year) == TRUE? 'TRUE,' : 'FALSE,';
      $region_error = $this->set_wine_region($region) == TRUE? 'TRUE,' : 'FALSE,';
      $stock_error = $this->set_wine_stock($stock) == TRUE? 'TRUE,' : 'FALSE,';
